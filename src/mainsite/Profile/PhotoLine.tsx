        ...
        <div className="bg-gray-500 rounded-xl mt-3 flex ">
            <div className="mt-3 mr-3 ml-3 flex flex-col">
                ...
                <div className="flex gap-1 w-fit mb-2">
                    <Image.PreviewGroup>
                        <Image  src="https://i.pinimg.com/originals/95/76/72/95767226c54f7659f0ac6738117c408c.jpg" />
                        <Image
                            
                            src="https://i.pinimg.com/originals/95/76/72/95767226c54f7659f0ac6738117c408c.jpg"
                        />
                        <Image
